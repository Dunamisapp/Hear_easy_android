...
public class AppConstants {
	...
	public static File directory = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC);
	...
	public static final String TAG_BUTTON = "button_view";
	public static final String TAG_RADIO_BUTTON = "radio_button";

	public static final String COMMON_APP_FONT = "fonts/crimson_text_regular.ttf";
	public static final String CREAMSON_BOLD = "fonts/CrimsonText-Bold.ttf";
	public static final String CREAMSON_SEMI_BOLD = "fonts/CrimsonText-SemiBold.ttf";
	public static final String LOTO_BOLD = "fonts/lato.bold.ttf";
	public static final String LOTO_HEAVY = "fonts/lato.heavy.ttf";
