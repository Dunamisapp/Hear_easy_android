...
public class FingerprintDialog extends DialogFragment
    ...
    private boolean initCipher(Cipher cipher, String keyName) {
        try {
            ...
            MyToast.display(mContext, "Keys are invalidated after created. Retry the purchase\n"
                    + e.getMessage());

            return false;
        } catch (KeyStoreException | CertificateException | UnrecoverableKeyException | IOException
                | NoSuchAlgorithmException | InvalidKeyException e) {
            MyToast.display(mContext, "Failed to init cipher");
            return false;
        }
    }
...
//            startActivity(new Intent(mContext,DashBoardActivity.class));
            MyToast.display(mContext.getApplicationContext(), "Auth success");
            dismiss();
        } else {
            tvLogin.setVisibility(View.VISIBLE);
            MyToast.display(mContext.getApplicationContext(), "Auth failed");
        }
    }

    @Override
    public void onError(String s) {
        MyToast.display(mContext.getApplicationContext(), s);
    }

    @Override
    public void onHelp(String s) {
        MyToast.display(mContext.getApplicationContext(), "Auth help message:" + s);
    }
